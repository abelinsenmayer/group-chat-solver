...
/** @deprecated Retained for reference while the responsive restaurant solver is active. Do not import in application code. */
export default function SolveRestaurantsPageLegacy({
  people,
  overlap,
  onBack,
  initialStatus = null,
